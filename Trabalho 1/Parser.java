...
AnaliseLexica scanner;
    ...
    switch (tokenCorrente.token) {
        ...
        case SUBTRACAO: // Adicionado suporte para subtração
            return new Subtracao(null, null);
        case DIVISAO: // Adicionado suporte para divisão
            return new Divisao(null, null);
        default:
